...
![Version: 6.7.15-bb.2](https://img.shields.io/badge/Version-6.7.15--bb.2-informational?style=flat-square) ![AppVersion: v2.10.7](https://img.shields.io/badge/AppVersion-v2.10.7-informational?style=flat-square)
...
| redis.image.tag | string | `"7.2.4"` | Redis tag |
...
| redis.exporter.image.tag | string | `"v1.58.0"` | Tag to use for the redis-exporter |
