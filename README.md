...
![Version: 7.3.4-bb.0](https://img.shields.io/badge/Version-7.3.4--bb.0-informational?style=flat-square) ![AppVersion: v2.11.4](https://img.shields.io/badge/AppVersion-v2.11.4-informational?style=flat-square)
...
| global.image.tag | string | `"v2.11.4"` | Overrides the global Argo CD image tag whose default is the chart appVersion |
